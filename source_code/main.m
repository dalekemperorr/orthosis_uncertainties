...
if(MODE == 0)
    [ Delta_Alpha, Delta_Beta, Delta_Gamma, Delta_T, GammaValues_vector ] = calculate_fromfile( Axis_X_vector_nom, Axis_Y_vector_nom, Axis_Z_vector_nom, A_kon, B_kon, A_ort, B_ort, S, R, L);
else    
